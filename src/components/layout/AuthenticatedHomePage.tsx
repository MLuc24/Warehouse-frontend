    ...
    <div className="p-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Quản lý kho hàng và theo dõi hoạt động của doanh nghiệp bạn
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        >
          <div className="flex items-center mb-4">
            ...
            <h3 className="ml-4 text-lg font-semibold text-gray-900">Quản lý Sản phẩm</h3>
          </div>
          <p className="text-gray-600 mb-4">
            Xem, thêm, sửa và quản lý tất cả sản phẩm trong kho
          </p>
        ...
        >
          <div className="flex items-center mb-4">
            ...
            <h3 className="ml-4 text-lg font-semibold text-gray-900">Quản lý Nhà cung cấp</h3>
          </div>
          <p className="text-gray-600 mb-4">
