  ...
  return (
    <>
      ...
      <ConfirmationOverlay
        ...
        message={`Bạn có chắc chắn muốn xóa kho hàng "${selectedWarehouse?.warehouseName}"? Hành động này không thể hoàn tác và sẽ xóa tất cả dữ liệu liên quan.`}
        itemName={selectedWarehouse?.warehouseName}
        confirmText="Xóa kho hàng"
        cancelText="Hủy bỏ"
