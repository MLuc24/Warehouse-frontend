...
export const GOODS_RECEIPT_STATUS_LABELS = {
  ...
  [GOODS_RECEIPT_STATUS.AWAITING_APPROVAL]: 'Chờ phê duyệt',
  [GOODS_RECEIPT_STATUS.PENDING]: 'Chờ nhà cung cấp',
  [GOODS_RECEIPT_STATUS.SUPPLIER_CONFIRMED]: 'Nhà cung cấp đã xác nhận',
  [GOODS_RECEIPT_STATUS.COMPLETED]: 'Hoàn thành',
  [GOODS_RECEIPT_STATUS.CANCELLED]: 'Đã hủy',
  [GOODS_RECEIPT_STATUS.REJECTED]: 'Bị từ chối'
} as const

export const GOODS_RECEIPT_STATUS_COLORS = {
  [GOODS_RECEIPT_STATUS.DRAFT]: 'gray',
  [GOODS_RECEIPT_STATUS.AWAITING_APPROVAL]: 'orange',
  [GOODS_RECEIPT_STATUS.PENDING]: 'yellow',
  [GOODS_RECEIPT_STATUS.SUPPLIER_CONFIRMED]: 'blue',
  [GOODS_RECEIPT_STATUS.COMPLETED]: 'green',
  [GOODS_RECEIPT_STATUS.CANCELLED]: 'red',
  [GOODS_RECEIPT_STATUS.REJECTED]: 'red'
} as const
